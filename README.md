# [atm9sky-1.1.6](https://www.curseforge.com/minecraft/modpacks/all-the-mods-9-to-the-sky) on Curseforge
...
The docker on first run will download the same version as tagged of `atm9sky-1.1.6` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "atm9sky-1.1.6 Server Powered by Docker"
* LEVEL world
