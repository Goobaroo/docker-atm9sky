...
if ! [[ -f 'server-1.1.5.zip' ]]; then
	rm -fr config defaultconfigs kubejs mods packmenu *.zip forge*
	curl -Lo 'server-1.1.5.zip' 'https://mediafilez.forgecdn.net/files/6253/993/server-1.1.5.zip' || exit 9
	unzip -u -o 'server-1.1.5.zip' -d /data
